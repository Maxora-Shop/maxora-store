...
import { Zap, Clock, ShoppingBag, ShoppingCart, ArrowRight, Eye, Check, Star, Heart, ExternalLink } from 'lucide-react';
        ...
        {flashSaleProducts.map((product) => {
          ...
          return (
            <div
              ...
              className="group bg-white rounded-2xl border border-amber-200/90 overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col justify-between hover:-translate-y-1 h-full cursor-pointer"
            >
