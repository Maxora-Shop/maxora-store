...
export const DEFAULT_HERO_BANNERS: HeroBanner[] = [
  ...
  },
  {
    ...
    subtitle: "Save big on verified gadgets, headphones, smart watches, and home appliances with 100% authentic quality guarantee.",
    cta: "Explore Offers",
    ctaLink: "#products-catalog-section",
...
export const INITIAL_SETTINGS: StoreSettings = {
  ...
  site_meta_description: "Shop premium smartwatches, earbuds, mechanical keyboards, and lifestyle accessories online in Bangladesh. Fast Cash on Delivery across all 64 districts with 100% authentic quality guarantee.",
